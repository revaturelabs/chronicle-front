...
export declare class SatDatepicker<D> implements OnDestroy, CanColor {
    ...
    defaultColor: ThemePalette // this line is added here to fix an issue after upgrading to angular 10 !!! https://github.com/SaturnTeam/saturn-datepicker/issues/157
    rangeMode: boolean;
    private _rangeMode;
